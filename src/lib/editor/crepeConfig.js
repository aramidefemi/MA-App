...
function readSelectionText(view) {
...
export function createCrepe(options) {
  const { root, defaultValue, onAiClick, onNavigateWikilink, onUploadImage } = options
  ...
  crepe.editor.config((ctx) => {
    configureWikilink(ctx, { onNavigate: onNavigateWikilink })
  })
